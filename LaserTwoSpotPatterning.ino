...
// laser Variables
double lasertime1 =1000*10;
int laserpower1 = 1;
double lasertime2 = 1000*5;
int laserpower2 = 1;
...
void loop() {
      ...
      for (int i = 0; i < BEAKERS; i++)
      {
        ...
        if (i + 1 == 1)
        {
          ...
          else
          {
            ...
            //The is the beginning of the laser patterning code....This will hopefully create a Create three spots
            double updownlasetime = millis();
            
            
            analogWrite(3, 255 * laserpower1 / 100);
            Serial.println("Laser On 1");
            delay(lasertime1);
            analogWrite(3, 0);
            Serial.println("Laser Off 1");

            
              while (analogRead(A1) < 610) {
                LinearActuator->run(BACKWARD);
                while (analogRead(A1) < 610) {
                }
            ...
            analogWrite(3, 255 * laserpower2 / 100);
            Serial.println("Laser On 2");
            delay(lasertime2);
            analogWrite(3, 0);
            Serial.println("Laser Off 2");
  ...
  Serial.println("done with sample!");
  }
